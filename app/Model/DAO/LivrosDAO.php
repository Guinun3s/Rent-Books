...
class LivrosDAO extends DAO{
    ...
    public static function filtrarGenero($genero){
    ...
    public static function filtrarPreco($preco){
        $tabela = static::$tabela;
    ...
    public static function filtrarModo($modo){
        $tabela = static::$tabela;
    ...
    public static function filtrarTitulo($titulo){
        $tabela = static::$tabela;
